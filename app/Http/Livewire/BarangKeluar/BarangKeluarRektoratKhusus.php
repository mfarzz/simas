...
class BarangKeluarRektoratKhusus extends Component
{
    use WithPagination;
    public $nm_penerima, $idKategori, $idSubkategori, $idItem, $barcode, $jumlah, $tgl_keluar, $nama, $tabel_id, $no, $nm_item;
    ...
    {   
        ...
        $b = $a * $page;        
        $this->no = $b + 0;        
        return view('BarangKeluar.Khusus.Rektorat.index', [
