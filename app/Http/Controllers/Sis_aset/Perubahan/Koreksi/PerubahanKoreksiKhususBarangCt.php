...
class PerubahanKoreksiKhususBarangCt extends Controller
{
    ...
    {        
        ...
        return view('Sis_aset.Perubahan.Koreksi.Khusus.Barang.index',['data_aset'=>$data_aset, 'encripted_id'=>$encripted_id]);
    }
}
