...
class PerubahanKoreksiFakultasKhususBarangCt extends Controller
{
    ...
    {        
        ...
        return view('Sis_aset.Perubahan.Koreksi.Khusus.Fakultas.Barang.index',['data_aset'=>$data_aset, 'encripted_id'=>$encripted_id]);
    }
}
