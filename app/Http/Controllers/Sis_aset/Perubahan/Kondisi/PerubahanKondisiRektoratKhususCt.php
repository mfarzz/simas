...
class PerubahanKondisiRektoratKhususCt extends Controller
{
    public function index()
    {
        ...
        return view('Sis_aset.Perubahan.Kondisi.Khusus.Rektorat.index',['daftar_kategori'=> $daftar_kategori]);
    }
    ...
    public function store(Request $request)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    $jumlah_sppa = AsetUbahModel::where('a_kd_al', $datalokasi->a_kd_al)->where('a_kd_ajkt', 'B03')->where('a_thn_au', $thn)->count();
                    if($jumlah_sppa == 0)
                    {
                        $no_sppa = "1";
                    }
                    ...
                    $dataperubahan->a_kondisi_au = $request->kondisi;
                    ...
                    else if($request->kondisi==2)
                    {
                        $kondisi_barang = 0;
                    }
                    else if($request->kondisi==3)
                    {
                        $kondisi_barang = 0;
                    }
                    for ($a=$request->nup_awal; $a <= $request->nup_akhir ; $a++) { 
                        ...
                        $dataperubahanitem->a_kondisi_aui = $request->kondisi;
                        ...
                        $baris_aset_item_up->a_status_api = $kondisi_barang;
