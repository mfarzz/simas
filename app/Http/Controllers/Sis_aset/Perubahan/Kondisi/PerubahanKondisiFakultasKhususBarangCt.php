...
class PerubahanKondisiFakultasKhususBarangCt extends Controller
{
    ...
    {        
        ...
        return view('Sis_aset.Perubahan.Kondisi.Khusus.Fakultas.Barang.index',['data_aset'=>$data_aset, 'encripted_id'=>$encripted_id]);
    }
}
