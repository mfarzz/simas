...
class PerolehanPenyelesaianLangsungFakultasKhususBarangCt extends Controller
{
    ...
    {        
        ...
        return view('Sis_aset.Perolehan.PenyelesaianLangsung.Khusus.Fakultas.Barang.index',['data_aset'=>$data_aset, 'encripted_id'=>$encripted_id]);
    }
}
