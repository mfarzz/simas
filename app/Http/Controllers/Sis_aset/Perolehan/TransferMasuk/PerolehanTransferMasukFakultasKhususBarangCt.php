...
class PerolehanTransferMasukFakultasKhususBarangCt extends Controller
{
    ...
    {        
        ...
        join('aset_lokasi', 'aset_perolehan.a_kd_al_asal','=','aset_lokasi.a_kd_al')
        ->where('a_id_ap', $a_id_ap)->first();
        ...
        return view('Sis_aset.Perolehan.TransferMasuk.Khusus.Fakultas.Barang.index',['data_aset'=>$data_aset, 'data_asal'=>$data_asal, 'encripted_id'=>$encripted_id]);
    }
}
