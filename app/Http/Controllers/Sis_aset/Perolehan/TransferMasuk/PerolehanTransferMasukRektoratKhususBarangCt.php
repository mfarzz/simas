...
class PerolehanTransferMasukRektoratKhususBarangCt extends Controller
{
    ...
    {        
        ...
        return view('Sis_aset.Perolehan.TransferMasuk.Khusus.Rektorat.Barang.index',['data_aset'=>$data_aset, 'data_asal'=>$data_asal, 'encripted_id'=>$encripted_id]);
    }
}
