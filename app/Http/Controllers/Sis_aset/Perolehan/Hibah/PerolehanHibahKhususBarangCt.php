...
class PerolehanHibahKhususBarangCt extends Controller
{
    ...
    {        
        ...
        return view('Sis_aset.Perolehan.Hibah.Khusus.Barang.index',['data_aset'=>$data_aset, 'encripted_id'=>$encripted_id]);
    }
}
