...
class PerolehanPembelianFakultasKhususRincianCt extends Controller
{
    ...
    {        
        ...
        return view('Sis_aset.Perolehan.Pembelian.Khusus.Fakultas.Rincian.index',['data_aset'=>$data_aset, 'encripted_id'=>$encripted_id]);
    }
