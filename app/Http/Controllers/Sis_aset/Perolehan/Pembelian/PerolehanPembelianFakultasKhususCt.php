...
class PerolehanPembelianFakultasKhususCt extends Controller
{
    public function index()
    {
        ...
        return view('Sis_aset.Perolehan.Pembelian.Khusus.Fakultas.index',['daftar_kategori'=> $daftar_kategori]);
    }
    ...
    {   
        $data = AsetPembelianModel::where('a_id_ap',$request->a_id_ap)->first();
