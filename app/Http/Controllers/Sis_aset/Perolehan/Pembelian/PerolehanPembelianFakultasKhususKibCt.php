...
class PerolehanPembelianFakultasKhususKibCt extends Controller
{
    ...
    {        
        ...
        return view('Sis_aset.Perolehan.Pembelian.Khusus.Fakultas.Kib.index',['data_aset'=>$data_aset, 'data_provinsi'=>$data_provinsi, 'data_dok_kepemilikan' => $data_dok_kepemilikan, 'data_status_digunakan' => $data_status_digunakan, 'encripted_id'=>$encripted_id]);
    }
