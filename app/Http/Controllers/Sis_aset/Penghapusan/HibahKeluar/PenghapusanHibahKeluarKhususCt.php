...
class PenghapusanHibahKeluarKhususCt extends Controller
{
    public function index()
    {
        ...
        if(request()->ajax()) {
            ...
            join('aset_lokasi', 'aset_hapus.a_kd_al','=','aset_lokasi.a_kd_al')
        ...
        return view('Sis_aset.Penghapusan.HibahKeluar.Khusus.index',['daftar_kategori'=> $daftar_kategori]);
    }
}
