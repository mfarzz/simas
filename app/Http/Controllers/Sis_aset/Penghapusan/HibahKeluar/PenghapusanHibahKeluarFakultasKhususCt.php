...
class PenghapusanHibahKeluarFakultasKhususCt extends Controller
{
    public function index()
    {
        ...
        return view('Sis_aset.Penghapusan.HibahKeluar.Khusus.Fakultas.index',['daftar_kategori'=> $daftar_kategori]);
    }
