...
namespace App\Http\Controllers\Sis_aset\Penghapusan\Hapus;
...
class PenghapusanHapusRektoratKhususCt extends Controller
{
    public function index()
    {
        ...
        return view('Sis_aset.Penghapusan.Hapus.Khusus.Rektorat.index',['daftar_kategori'=> $daftar_kategori]);
    }
    ...
    public function store(Request $request)
    {
        ...
        else
        {
            ...
            {                
                ...
                {
                    $jumlah_sppa = AsetHapusModel::where('a_kd_al', $datalokasi->a_kd_al)->where('a_kd_ajkt', 'C01')->where('a_thn_ah', $thn)->count();
                    if($jumlah_sppa == 0)
                    {
                        $no_sppa = "1";
                    }
