...
class PenghapusanHapusRektoratKhususBarangCt extends Controller
{
    ...
    {        
        ...
        return view('Sis_aset.Penghapusan.Hapus.Khusus.Rektorat.Barang.index',['data_aset'=>$data_aset, 'encripted_id'=>$encripted_id]);
    }
}
