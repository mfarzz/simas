...
class PenghapusanTransferKeluarRektoratKhususCt extends Controller
{
    public function index()
    {
        ...
        return view('Sis_aset.Penghapusan.TransferKeluar.Khusus.Rektorat.index',['daftar_kategori'=> $daftar_kategori, 'daftar_lokasi'=> $daftar_lokasi]);
    }
