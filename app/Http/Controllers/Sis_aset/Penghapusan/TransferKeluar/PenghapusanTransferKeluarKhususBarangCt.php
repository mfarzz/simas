...
class PenghapusanTransferKeluarKhususBarangCt extends Controller
{
    ...
    {        
        ...
        return view('Sis_aset.Penghapusan.TransferKeluar.Khusus.Barang.index',['data_aset'=>$data_aset, 'encripted_id'=>$encripted_id]);
    }
}
