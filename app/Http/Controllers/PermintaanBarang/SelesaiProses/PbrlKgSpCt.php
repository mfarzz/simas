...
class PbrlKgSpCt extends Controller
{
    public function index($encripted_id)
    {
        ...
        return view('PermintaanBarang.KepalaGudang.Rektorat.SelesaiProses.Log.index',['encripted_id'=> $encripted_id, 'cek_pbr' =>$cek_pbr]);
    }
}
