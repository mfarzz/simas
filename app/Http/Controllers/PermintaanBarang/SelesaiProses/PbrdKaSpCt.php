...
class PbrdKaSpCt extends Controller
{
    public function index($encripted_id)
    {
        ...
        return view('PermintaanBarang.KasiLogistik.Rektorat.SelesaiProses.Daftar.index',['encripted_id'=> $encripted_id,'daftar_kategori'=> $daftar_kategori, 'daftar_barang'=> $daftar_barang, 'cek_pbr' =>$cek_pbr]);
    }
}
