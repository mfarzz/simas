...
class PbrdSpCt extends Controller
{
    public function index($encripted_id)
    {
        ...
        return view('PermintaanBarang.Rektorat.SelesaiProses.Daftar.index',['encripted_id'=> $encripted_id,'daftar_kategori'=> $daftar_kategori, 'daftar_barang'=> $daftar_barang, 'cek_pbr' =>$cek_pbr]);
    }
}
