...
class PbflKgSpCt extends Controller
{
    public function index($encripted_id)
    {
        ...
        return view('PermintaanBarang.KepalaGudang.Fakultas.SelesaiProses.Log.index',['encripted_id'=> $encripted_id, 'cek_pbf' =>$cek_pbf]);
    }
}
