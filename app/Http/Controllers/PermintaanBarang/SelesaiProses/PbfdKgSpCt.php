...
class PbfdKgSpCt extends Controller
{
    public function index($encripted_id)
    {
        ...
        return view('PermintaanBarang.KepalaGudang.Fakultas.SelesaiProses.Daftar.index',['encripted_id'=> $encripted_id,'daftar_kategori'=> $daftar_kategori, 'daftar_barang'=> $daftar_barang, 'cek_pbf' =>$cek_pbf]);
    }
}
