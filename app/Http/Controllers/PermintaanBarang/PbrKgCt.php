...
class PbrKgCt extends Controller
{
    public function index()
    {
        ...
        return view('PermintaanBarang.KepalaGudang.Rektorat.index');
    }
    ...
    public function validasi(Request $request)
    {
        ...
        $tgl = date("Y-m-d");
        $user_id = auth()->user()->id;
        $cekDataStatus = PbsModel::where('untuk_pbs', 2)->where('level_pbs', 4)->where('urutan_pbs', 1)->first();
