...
class OpsikUvSelisihPrintCt extends Controller
{
    Public Function index($filter)
    {
        ...
        $header = function() use ($sem_opfk, $thn_opfk, $no_opfk, $tgl_opfk, $datalokasi, $lokasi) {
            ...
            PDF::Cell(0, 0, 'OPNAME FISIK BARANG PERSEDIAAN (SELISIH)', 0, 1, 'C', 0, '', 0);
        ...
        $no=1;
            ...
            foreach($datalap as $barislap)
            {
                ...
                PDF::Cell(15, 0, "$barislap->jmlh_opfkdetitm", 1, 0, 'C', 0, '', true);
