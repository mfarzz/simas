<x-form-input>    
    ...
    @endif  
    <x-input type="number" : judulform="Jumlah yang Diminta" : placeholder="Entrikan Jumlah yang Diminta" : name="jumlah" : jenis="warning" />
    <x-input type="number" : judulform="Perkiraan Harga" : placeholder="Entrikan Perkiraan Harga" : name="estimasi_harga" : jenis="warning" />
</x-form-input>