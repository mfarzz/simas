<x-form-input>  
    <x-input-select judulform="Lembaga/Bidang/UPT" : name="id_ur" : jenis="warning">
    ...
    <x-input type="text" : judulform="Nama Penerima" : placeholder="Entrikan Nama Penerima" : name="nm_penerima" : jenis="warning" />
    ...
    <x-input type="date" : judulform="Tanggal Keluar" : placeholder="Entrikan Tanggal Keluar" : name="tgl_keluar" : jenis="warning" />
</x-form-input>