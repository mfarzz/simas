        ...
        <div class="col-12">                
            <div class="box">
                <div class="box-body ribbon-box">
                    <div class="ribbon ribbon-success">Daftar Proses Permintaan Barang Selesai di Proses
                    </div>                    
                ...
                <a href="/permintaan-barang-kg-selesaiproses-pimf"  data-bs-toggle="tooltip" data-bs-placement="left" title="Kembali ke daftar permintaan barang selesai proses"><button type="button" class="btn btn-success waves-effect btn-label waves-light"><i class="fa fa-mail-reply"></i> Kembali Ke Daftar Permintaan Barang di Proses </button></a>
            </div>
        </div>
    </div>
</section>
...
$(document).ready( function () {
    ...
    $('#data-datatable').DataTable({
        ...
        ajax: "{{ url('permintaan-barang-kg-pimf-selesaiproses-log', ['encripted_id' => $encripted_id]) }}",
        columns: [
