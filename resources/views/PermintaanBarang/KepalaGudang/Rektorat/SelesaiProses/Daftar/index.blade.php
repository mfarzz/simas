...
$(document).ready( function () {
    ...
    $('#data-datatable').DataTable({
        ...
        ajax: "{{ url('permintaan-barang-kg-pimr-selesaiproses-daftar', ['encripted_id' => $encripted_id]) }}",
        columns: [
