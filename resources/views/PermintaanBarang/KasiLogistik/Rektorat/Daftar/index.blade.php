    ...
    <div class="row">
        <div class="col-12">                
            <div class="box">
                ...
                <a href="/permintaan-barang-kasilogistik-pimr"  data-bs-toggle="tooltip" data-bs-placement="left" title="Kembali ke daftar permintaan barang"><button type="button" class="btn btn-success waves-effect btn-label waves-light"><i class="fa fa-mail-reply"></i> Kembali Ke Daftar Permintaan Barang </button></a>
            </div>
        </div>
    </div>
</section>
...
$(document).ready( function () {
    ...
    $('#data-datatable').DataTable({
        ...
        ajax: "{{ url('permintaan-barang-kasilogistik-pimr-daftar', ['encripted_id' => $encripted_id]) }}",
        columns: [
...
function editFunc(id_pbrd){  
    ...
    $.ajax({
        type:"POST",
        url: "{{ url('permintaan-barang-kasilogistik-pimr-daftar-edit') }}",
        ...
        success: function(res){
            ...
            $('#jumlah_setujui').val(res.jmlh_setuju_pbrd);
            $('#status_ajuan').val(res.status_pbrd);
            $('#ket').val(res.ket_pbrd);
        }
    });    
}  
...
$('#DataForm').submit(function(e) {
    ...
    $.ajax({
        type:'POST',
        url: "{{ url('permintaan-barang-kasilogistik-pimr-daftar-store')}}",
        data: formData,
        cache:false,
        contentType: false,
        processData: false,
