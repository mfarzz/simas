        ...
        <div class="col-12">                
            <div class="box">
                <div class="box-body ribbon-box">
                    <div class="ribbon ribbon-success">Daftar Permintaan Barang Selesai di Proses Unit Rektorat Item Barang
                    </div>                    
...
$(document).ready( function () {
    ...
    $('#data-datatable').DataTable({
        ...
        ajax: "{{ url('permintaan-barang-kasilogistik-pimr-selesaiproses-daftar', ['encripted_id' => $encripted_id]) }}",
        columns: [
