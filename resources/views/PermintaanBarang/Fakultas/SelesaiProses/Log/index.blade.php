...
$(document).ready( function () {
    ...
    $('#data-datatable').DataTable({
        ...
        ajax: "{{ url('permintaan-barang-pimf-selesaiproses-log', ['encripted_id' => $encripted_id]) }}",
        columns: [
