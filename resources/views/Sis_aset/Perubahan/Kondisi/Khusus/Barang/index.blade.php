            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="/perubahan-kondisi-khusus-aset"  data-bs-toggle="tooltip" data-bs-placement="left" title="Kembali ke daftar perubahan kondisi"><button type="button" class="btn btn-success waves-effect waves-light"><i class="fas fa-reply"></i> Kembali Ke Daftar Perubahan Kondisi </button></a>
                    </div>                    
                </div>
            </div>
        </div>
...
$(document).ready( function () {
    ...
    $('#data-datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ url('perubahan-kondisi-khusus-aset-barang', ['encripted_id' => $encripted_id]) }}",
        columns: [
