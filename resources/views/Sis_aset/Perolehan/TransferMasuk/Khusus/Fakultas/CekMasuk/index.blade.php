            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="/perolehan-transfermasuk-opf-khusus-aset"  data-bs-toggle="tooltip" data-bs-placement="left" title="Kembali ke daftar transfer masuk"><button type="button" class="btn btn-success waves-effect waves-light"><i class="fas fa-reply"></i> Kembali Ke Daftar Transfer Masuk </button></a>
                    </div>
                </div>
            </div>
        </div>
...
$(document).ready( function () {
    ...
    $('#data-datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ url('perolehan-transfermasuk-opf-khusus-aset-cek') }}",
        columns: [
...
function editFunc(a_id_ah){
    $.ajax({
        type:"POST",
        url: "{{ url('perolehan-transfermasuk-opf-khusus-aset-cek-edit') }}",
...
$('#DataForm').submit(function(e) {
    ...
    $.ajax({
        type:'POST',
        url: "{{ url('perolehan-transfermasuk-opf-khusus-aset-store')}}",
        data: formData,
        cache:false,
        contentType: false,
        processData: false,
