                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-end">
                                <a href="/perolehan-transfermasuk-opr-khusus-aset-cek" title="Tambah Data">
...
$(document).ready( function () {
    ...
    $('#data-datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ url('perolehan-transfermasuk-opr-khusus-aset') }}",
        columns: [
            ...
            { 
                ...
                render: function(data, type, row) {
                    ...
                    '<a href="perolehan-transfermasuk-opr-khusus-aset-barang/' + row.a_id_ap_en + '"  data-bs-toggle="tooltip" data-bs-placement="left" title="Rincian Barang" class="btn btn-rounded btn-sm btn-primary"><i class="fa fa-book fa-sm"></i></a> ';
                    return buttons;
                }
            },
        ],
...
function deleteFunc(a_id_ap){
    ...
    if (confirm(pesan) == true) {
        ...
        $.ajax({
            type:"POST",
            url: "{{ url('perolehan-transfermasuk-opr-khusus-aset-delete') }}",
