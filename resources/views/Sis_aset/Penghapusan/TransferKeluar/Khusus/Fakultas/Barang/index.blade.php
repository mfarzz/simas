                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Reklasifikasi Keluar</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="/penghapusan-transferkeluar-opf-khusus-aset"  data-bs-toggle="tooltip" data-bs-placement="left" title="Kembali ke daftar penghapusan reklasifi keluar"><button type="button" class="btn btn-success waves-effect waves-light"><i class="fas fa-reply"></i> Kembali Ke Daftar Penghapusan Transfer Keluar </button></a>
                    </div>                    
                </div>
            </div>
        </div>
...
$(document).ready( function () {
    ...
    $('#data-datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ url('penghapusan-transferkeluar-opf-khusus-aset-barang', ['encripted_id' => $encripted_id]) }}",
        columns: [
