            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="/penghapusan-hibahkeluar-opf-khusus-aset"  data-bs-toggle="tooltip" data-bs-placement="left" title="Kembali ke daftar penghapusan hibah keluar"><button type="button" class="btn btn-success waves-effect waves-light"><i class="fas fa-reply"></i> Kembali Ke Daftar Penghapusan Hibah Keluar </button></a>
                    </div>                    
                </div>
            </div>
        </div>
...
$(document).ready( function () {
    ...
    $('#data-datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ url('penghapusan-hibahkeluar-opf-khusus-aset-barang', ['encripted_id' => $encripted_id]) }}",
        columns: [
