            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="/daftar-barang-ruangan-opf-aset"  data-bs-toggle="tooltip" data-bs-placement="left" title="Kembali ke daftar barang ruangan"><button type="button" class="btn btn-success waves-effect waves-light"><i class="fas fa-reply"></i> Kembali Ke Daftar Barang Ruangan </button></a>
                    </div>                    
                </div>
            </div>
        </div>
...
$(document).ready( function () {
    ...
    $('#data-datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ url('daftar-barang-ruangan-opf-aset-barang-rincian', ['encripted_id' => $encripted_id]) }}",
        columns: [
