                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Daftar Barang Ruangan</a></li>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-md-12">
                            <div class="box bt-3 border-info">
                              ...
                              <div class="box-body">
                                ...
                                <p> Ruangan : {{ $data_aset->a_kd_arf }} - {{ $data_aset->a_nm_arf }} </p>
                                <p> Penanggung Jawab : {{ $data_aset->a_nip_pj_arf }} - {{ $data_aset->a_nm_pj_arf }} </p>
                              </div>
                            </div>
                        </div>
                        ...
                        <a href="/daftar-barang-ruangan-opr-aset"  data-bs-toggle="tooltip" data-bs-placement="left" title="Kembali ke daftar barang ruangan"><button type="button" class="btn btn-success waves-effect waves-light"><i class="fas fa-reply"></i> Kembali Ke Daftar Barang Ruangan </button></a>
                    </div>                    
                </div>
            </div>
        </div>
...
$(document).ready( function () {
    ...
    $('#data-datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: "{{ url('daftar-barang-ruangan-opr-aset-barang-rincian', ['encripted_id' => $encripted_id]) }}",
        columns: [
