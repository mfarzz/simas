                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-4 col-sm-4 col-md-4 col-lg-2">
                                <a href="/lap-opf-persediaan-print/{{ $filter }}/{{ $lokasi }}"  target="_blank" data-bs-placement="left" title="Cetak Data"><button type="button" class="waves-effect waves-light btn btn-primary mb-5"><i class="fa fa-print"></i> Cetak </button></a>
                            </div>
                        </div>
                        <br>               
                    </div>
