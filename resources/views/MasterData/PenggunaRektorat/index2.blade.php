            ...
            <div class="col-12">                
                <div class="box">
                    <div class="box-body ribbon-box">
                        <div class="ribbon ribbon-success">Daftar Pengguna Bagian Rektorat</div>
                    </div> <!-- end box-body-->                    
                    <div class="box-body">
                        <div class="row">
                        ...
                        <br>
                        @include('MasterData.PenggunaRektorat.create')
                        @include('MasterData.PenggunaRektorat.update')
                        @include('MasterData.PenggunaRektorat.hapus')                        
