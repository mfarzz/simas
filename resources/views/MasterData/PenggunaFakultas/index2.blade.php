            ...
            <div class="col-12">                
                <div class="box">
                    <div class="box-body ribbon-box">
                        <div class="ribbon ribbon-success">Daftar Pengguna Fakultas</div>
                    </div> <!-- end box-body-->                    
                    <div class="box-body">
                        <div class="row">
                        ...
                        <br>
                        @include('MasterData.PenggunaFakultas.create')
                        @include('MasterData.PenggunaFakultas.update')
                        @include('MasterData.PenggunaFakultas.hapus')                        
                                ...
                                <table id="tech-companies-1" class="table table-striped">
                                    ...
                                    @foreach ($data as $value)                                    
                                        <tr>
                                            ...
                                            <td style=' border:1px solid #90AFC5 ; color:black'>{{ $value->username }}</td>
                                            <td style=' border:1px solid #90AFC5 ; color:black'>{{ $value->name }}</td>
                                            <td style='border:1px solid #90AFC5; color:black'>                                            
                                                <a href="#"  data-bs-toggle="tooltip" data-bs-placement="left" title="Ubah Data"><button type="button" data-bs-toggle="modal" data-bs-target=".ubahModal" wire:click="edit({{ $value->id }})" class="btn btn-warning btn-rounded btn-sm waves-effect"><i class="fa fa-pencil fa-sm"></i></button></a>
                                                <a href="#"  data-bs-toggle="tooltip" data-bs-placement="left" title="Hapus Data"><button type="button" data-bs-toggle="modal" data-bs-target=".hapusModal" wire:click="hapus({{ $value->id }})" class="btn btn-danger btn-rounded btn-sm waves-effect"><i class="fa fa-trash fa-sm"></i></button></a>
                                            </td>
                                        </tr>                                    
                                    @endforeach
                                    @if($no=="0")                                    
