            ...
            <div class="col-12">                
                <div class="box">
                    <div class="box-body ribbon-box">
                        <div class="ribbon ribbon-success">Daftar Sub Sub Kategori</div>
                    </div> <!-- end box-body-->                    
                    <div class="box-body">
                        <div class="col-md-12">
                        ...
                        <br>
                        @include('MasterData.Kategori.SubKategori.SubSubKategori.create')
                        @include('MasterData.Kategori.SubKategori.SubSubKategori.update')
                        @include('MasterData.Kategori.SubKategori.SubSubKategori.hapus')
                        ...
                        <div class="table-rep-plugin">
                            <div class="table-responsive mb-0" data-pattern="priority-columns">
                                <table id="tech-companies-1" class="table table-striped">
                                    ...
                                    @php $encript = Crypt::encryptString($value->kd_sskt); @endphp
                                        <tr>
                                            ...
                                            <td style=' border:1px solid #90AFC5 ; color:black'>{{ $value->kd_sskt }}</td>
                                            <td style=' border:1px solid #90AFC5 ; color:black'>{{ $value->no_sskt }}</td> 
                                            ...
                                            <td style='border:1px solid #90AFC5; color:black'>                                            
                                                <a href="#"  data-bs-toggle="tooltip" data-bs-placement="left" title="Ubah Data"><button type="button" data-bs-toggle="modal" data-bs-target=".ubahModal" wire:click="edit({{ $value->id_sskt }})" class="btn btn-warning btn-rounded btn-sm waves-effect"><i class="fa fa-pencil fa-sm"></i></button></a>
                                                <a href="#"  data-bs-toggle="tooltip" data-bs-placement="left" title="Hapus Data"><button type="button" data-bs-toggle="modal" data-bs-target=".hapusModal" wire:click="hapus({{ $value->id_sskt }})" class="btn btn-danger btn-rounded btn-sm waves-effect"><i class="fa fa-trash fa-sm"></i></button></a>      
                                                <a href="/master-kategoribarang/{{ $encript }}"  data-bs-toggle="tooltip" data-bs-placement="left" title="Daftar Barang"><button type="button" class="btn btn-rounded btn-sm btn-success"><i class="fa fa-book"></i></button></a>      
                                            </td>
                                        </tr>                                    
                                    @endforeach
                                    @if($no=="0")                                    
