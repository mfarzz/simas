<a href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="left" title="Ubah Data" onClick="editFunc({{ $id }})" data-original-title="Edit" class="edit btn btn-success btn-rounded btn-sm waves-effect">
