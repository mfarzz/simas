            ...
            <div class="col-12">                
                <div class="box">
                    <div class="box-body ribbon-box">
                        <div class="ribbon ribbon-success">Daftar Barang Usang Khusus</div>
                    </div> <!-- end box-body-->                    
                    <div class="box-body">    
                        ...
                        @include('BarangUsang.Khusus.create')
                        @include('BarangUsang.Khusus.hapus')
                        @include('BarangUsang.Khusus.detail')                        
                                ...
                                <table id="tech-companies-1" class="table table-striped">
                                    ...
                                    @foreach ($data as $value)
                                        <tr>
                                            ...
                                            <td style=' border:1px solid #90AFC5 ; color:black'>{{ $value->ket_bu }}</td>
                                            ...
                                            <td style=' border:1px solid #90AFC5 ; color:black' align='right'>{{ $value->jmlh_bu }}</td>
                                            <td style=' border:1px solid #90AFC5 ; color:black'>{{ \Carbon\Carbon::parse($value->tgltentu_bu)->format('d M Y')}}</td>      
                                            <td style='border:1px solid #90AFC5; color:black'>
                                                <a href="#"  data-bs-toggle="tooltip" data-bs-placement="left" title="Detail Data"><button type="button" data-bs-toggle="modal" data-bs-target=".formDetailModal" wire:click="detail({{ $value->id_bu }})" class="btn btn-primary btn-rounded btn-sm waves-effect"><i class="fa fa-book fa-sm"></i></button></a>  
                                                <a href="#"  data-bs-toggle="tooltip" data-bs-placement="left" title="Hapus Data"><button type="button" data-bs-toggle="modal" data-bs-target=".hapusModal" wire:click="hapus({{ $value->id_bu }})" class="btn btn-danger btn-rounded btn-sm waves-effect"><i class="fa fa-trash fa-sm"></i></button></a>           
                                            </td>
                                        </tr>                                    
                                    @endforeach
                                    @if($no=="0")                                    
