<x-form-input>        
    ...
    <x-input type="number" : judulform="Harga" : placeholder="Entrikan Harga" : name="harga" : jenis="warning" />
    <x-input type="date" : judulform="Tanggal Perolehan" : placeholder="Entrikan Tanggal Perolehan" : name="tgl_perolehan" : jenis="warning" />
    <x-input type="date" : judulform="Tanggal Buku" : placeholder="Entrikan Tanggal Buku" : name="tgl_buku" : jenis="warning" />
</x-form-input>