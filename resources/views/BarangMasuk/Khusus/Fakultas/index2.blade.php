            ...
            <div class="col-12">                
                <div class="box">
                    ...
                    <div class="box-body">    
                        ...
                        @include('BarangMasuk.Khusus.Fakultas.create')
                        @include('BarangMasuk.Khusus.Fakultas.hapus') 
                                ...
                                <table id="tech-companies-1" class="table table-striped">
                                    ...
                                    @foreach ($data as $value)
                                        <tr>
                                            ...
                                            <td style=' border:1px solid #90AFC5 ; color:black' align='right'>{{ $value->jmlh_awal_bmf }}</td>
                                            <td style=' border:1px solid #90AFC5 ; color:black'>{{ \Carbon\Carbon::parse($value->tglperolehan_bmf)->format('d M Y')}}</td>
                                            <td style=' border:1px solid #90AFC5 ; color:black'>{{ \Carbon\Carbon::parse($value->tglbuku_bmf)->format('d M Y')}}</td>   
                                            <td style='border:1px solid #90AFC5; color:black'>
                                                <a href="#"  data-bs-toggle="tooltip" data-bs-placement="left" title="Detail Data"><button type="button" data-bs-toggle="modal" data-bs-target=".formDetailModal" wire:click="detail({{ $value->id_bmf }})" class="btn btn-primary btn-rounded btn-sm waves-effect"><i class="fa fa-book fa-sm"></i></button></a>  
                                                <a href="#"  data-bs-toggle="tooltip" data-bs-placement="left" title="Hapus Data"><button type="button" data-bs-toggle="modal" data-bs-target=".hapusModal" wire:click="hapus({{ $value->id_bmf }})" class="btn btn-danger btn-rounded btn-sm waves-effect"><i class="fa fa-trash fa-sm"></i></button></a>           
                                            </td>
                                        </tr>                                    
                                    @endforeach
                                    @if($no=="0")                                    
