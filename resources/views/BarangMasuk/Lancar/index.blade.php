                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Aset Lancar</li>
                        </ol>
                    </nav>
                </div>
            </div>        
            ...
            <div class="col-12">                
                <div class="box">
                    <div class="box-body ribbon-box">
                        <div class="ribbon ribbon-success">Daftar Permintaan Barang Sudah Disetujui</div>
                    </div> <!-- end box-body-->                    
                    <div class="box-body">
                        <div class="row">
                                ...
                                <table id="tech-companies-1" class="table table-striped">
                                    ...
                                    @php $encript = Crypt::encryptString($value->id_pb); @endphp                                  
                                        <tr>
                                            ...
                                            <td style=' border:1px solid #90AFC5 ; color:black'>{{ \Carbon\Carbon::parse($value->updated_at)->format('d M Y')}}</td>
                                            <td style=' border:1px solid #90AFC5 ; color:black'>
                                                @if($value->status_pb==2)
                                                Disetujui
                                                @elseif($value->status_pb==3)
                                                Lengkap
                                                @endif
                                            </td>      
                                            <td style='border:1px solid #90AFC5; color:black'> 
                                                <a href="/barang-masuk-lancar-detail/{{ $encript }}"  data-bs-toggle="tooltip" data-bs-placement="left" title="Daftar Barang Masuk"><button type="button" class="btn btn-rounded btn-sm btn-success"><i class="fa fa-book"></i></button></a>
                                            </td>
                                        </tr>                                    
                                    @endforeach
                                    @if($no=="0")                                    
