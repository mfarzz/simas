                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="#" class="d-block auth-logo">
                                        <img src="assets/images/logo_stmik.jpg" alt="" height="28"> <span class="logo-txt">STMIK Indonesia</span>
                                    </a>
                                </div>
                                <div class="auth-content my-auto">
                                    ...
                                    <form method="POST" class="mt-4 pt-2" action="/kirim">
                                        ...
                                        <div class="mb-3">
                                            <label for="useremail" class="form-label">No WA</label>
                                            <input type="text" class="form-control" name="nowa" placeholder="Silahkan entrikan No Wa" required>  
                                            <div class="invalid-feedback">
                                                Silahkan entrikan no wa
                                            </div>      
                                        </div>
