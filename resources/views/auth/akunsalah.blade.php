                                    ...
                                    <div class="text-center">
                                        <div class="avatar-lg mx-auto">
                                            <div class="avatar-title rounded-circle bg-light">
                                                <i class="bx bx-error h2 mb-0 text-primary"></i>
                                            </div>
                                        </div>
                                        <div class="p-2 mt-4">
                                            <h4>Gagal Terkirim !</h4>
                                            <p class="text-muted">Mohon maaf NIM / No BP yang anda entrikan tidak ditemukan. Silahkan di cek kembali NIM / No BP anda.</p>
                                            <div class="mt-4">
                                                <a href="/register" class="btn btn-primary w-100">Kembali Ke Halaman Aktivasi Akun</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
